		...
		command_palette = {
			{
				"File",
				{
					...
					":lua require('yq.funcs').yank_current_file_name()",
				},
				...
				{
					"Project Files",
					":lua require'yq.telescope'.project_files()",
					1,
				},
			},
			{
			...
			{ "Terminal", { "Vertical Right", ":vsp | terminal", 1 } },
			{
				...
				{
					"Browse Notes",
					"lua require'yq.telescope'.browse_notes()",
					1,
				},
				{ "Find Notes", "lua require'yq.telescope'.find_notes()", 1 },
				{
					"Search/Grep Notes",
					"lua require'yq.telescope'.grep_notes()",
					1,
				},
			},
			{
				...
				{
					"Fold Column",
					":lua require'yq.settings'.toggle_fold_col()",
				},
			},
			{
				"Neovim",
				...
				{
					"Search TODOS",
					":lua require'yq.telescope'.search_todos()",
				},
			},
		},
	},
